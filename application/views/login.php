...
<body>
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(<?php echo base_url(); ?>assets/images/background/19870.jpg); background-size:73% 100%; background-position: left center; background-repeat: no-repeat;">
        <div class="login-box card" style="background-image: url(<?php echo base_url(); ?>assets/images/background/5096154.jpg); background-size: cover; background-position: center; background-repeat: no-repeat; padding: 20px;">
        <div class="form-background" >
    <form class="form-horizontal form-material" method="post" id="loginform" action="login/Login_Auth">
    <img src="<?php echo base_url(); ?>assets/images/login-icon.png" alt="Home" style="width: 325px; height: 125px; display: block; margin-left: auto; margin-right: auto;" />
