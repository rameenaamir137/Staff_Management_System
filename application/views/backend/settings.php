                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <?php if($settingsvalue->sitelogo){ ?>
                                                    <img src="assets/images/projects/logo-white.png" height="100" width="167">
                                                    <?php } else { ?>
                                                    <img src="<?php echo base_url(); ?>assets/images/projects/logo-white.png" height="100" width="167">
                                                <?php } ?>
                                                </div>
